...
void    testMap_erase_root() {
    ...
    my_tree._tree.erase( my_tree._tree.root() );
    my_tree._tree.erase( my_tree._tree.root() );
    my_tree._tree.erase( my_tree._tree.root() );
    my_tree._tree.erase( my_tree._tree.root() );
...
void    testMap_swap() {
    ...
    // std::cout << iter_my_tree._tree1->first << " " << iter_my_tree._tree1->second << "\t  ";
    // std::cout << iter_std_tree1->first << " " << iter_std_tree1->second << "\t  ";
    // std::cout << iter_my_tree._tree2->first << " " << iter_my_tree._tree2->second << "\t  ";
    // std::cout << iter_std_tree2->first << " " << iter_std_tree2->second << '\n';
    ...
    std::cout << "ft::map<int, std::string>   my_tree._tree3(my_tree._tree1);" << std::endl;
...
void    testMap_iterator_reverse() {
...

    {
        ...
        iter_my_tree2 =  my_tree._tree.root();
        std::map<int, std::string>::reverse_iterator   iter_std_tree3(std_tree.find(my_tree._tree.root()->first));
...
void    testMap_iterator() {
    ...
    std::cout << "my_tree.end().base()->parent->data.first = " << my_tree._tree.end().base()->parent->data.first << std::endl;
    ...
    iter1 = my_tree._tree.root();
    iter2 = static_cast<ft::map<int, std::string>::iterator >(my_tree._tree.root().base()->left);
    ...
    iter2 = static_cast<ft::map<int, std::string>::iterator >(my_tree._tree.end().base()->parent);
...
void    testMap_insert_2() {
    ...
    ft::map<int, std::string>   my_tree(ft::make_pair(80, "YYYYY"));
...
void    testTree_iterator() {
    ...
    ft::rbt<ft::pair<int, std::string> >    my_tree;
    ...
    std::cout << "\033[34m" << "\t test iter1 = iter2 " << "\033[0m" << std::endl;
    ft::rbt<ft::pair<int, std::string> >::iterator iter1;
    iter1 = my_tree.root();
    std::cout << "(*iter1).data.first = " << (*iter1).first << std::endl;
    ft::rbt<ft::pair<int, std::string> >::iterator iter2;
    iter2 = static_cast<ft::rbt<ft::pair<int, std::string> >::iterator >(my_tree.root().base()->left);
...
void    testTree_insert() {
    ...
    //ft::rbt<ft::pair<int, std::string> >    my_tree(ft::make_pair(80, "Hello"));
    ft::rbt<ft::pair<int, std::string> >    my_tree;
    {
