...
class vector : public _Vector_base<T, Allocator> {
    ...
    //typedef ft::normal_iterator< ::ft::random_access_iterator_tag, T>       iterator;
    //typedef ft::normal_iterator< ::ft::random_access_iterator_tag, const T> const_iterator;
    typedef ft::normal_iterator< pointer, T>       iterator;
    typedef ft::normal_iterator< const_pointer, const T> const_iterator;
    ...
    template< class InputIt >
        void    construct_base( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag );
    template< class InputIt >
    ...
    template< class InputIt >
        void    insert( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag );
    template< class InputIt >
        void    insert_base( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag );
    template< class InputIt >
    ...
    template< class InputIt >
        void    insert_count_more_than_end_to_pos(iterator & pos, size_type & count, InputIt first, ft::input_iterator_tag);
    void    insert_count_less_than_end_to_pos(iterator & pos, size_type & count, const T& value);
    template< class InputIt >
        void    insert_count_less_than_end_to_pos(iterator & pos, size_type & count, InputIt first, ft::input_iterator_tag);
...
typename vector<T, Allocator>::iterator 
    ...
    size_type dist_pos = ::ft::distance(begin(), pos);
...
template <class T, class Allocator>
    ...
    void 
        vector<T, Allocator>::
        construct_base( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag ) {
...
template <class T, class Allocator>
    ...
    void 
        vector<T, Allocator>::
        insert_base( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag ) {
        insert( pos, first, last, Iter_cat(first) );
}
...
template <class T, class Allocator>
    ...
    void 
        vector<T, Allocator>::
        insert( iterator pos, InputIt first, InputIt last, ::ft::input_iterator_tag tag_obj) {
...
void
    ...
    size_type i = 0;
    try {
        size_type to_construct = ::ft::distance(end().base(), pos.base() + count);
